# 修改 main_v4_updated.py 实现无限轮次反馈迭代（仅首次输入用户信息）
import pandas as pd
import json
import joblib
import numpy as np
...
from generate_llm_feedback import run_deepseek_prompt
...
def run_cycle(user_profile, user_row, feedback_scores=None, round_num=1):
    ...
    print("\\n🤖 LLM解释推荐方案如下：\\n", explain_plan_with_llm(best_plan, user_profile))
    return best_plan
